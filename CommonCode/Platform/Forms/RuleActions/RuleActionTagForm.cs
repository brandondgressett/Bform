...
public class RuleActionTagForm : IRuleActionEvaluator
{
    ...
    public string Name => RuleUtil.FixActionName(nameof(RuleActionTagForm));
    ...
    {
        using (PerfTrack.Stopwatch(nameof(RuleActionTagForm)))
        {
            ...
            try
            {
                ...
                await _formLogic.EventAddFormTags(
                    origin, id, inputs.AddTags,
